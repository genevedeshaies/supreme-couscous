...
#### Matériel requis (Jour 1) : <!-- omit in toc -->
|Produit            |Quantité requise|Commandé|Reçu|
|-------------------|----------------|--------|----|
|LysoTracker Red    |1 uL/groupe     |        |    |
|Hoescht            |150 uL          |        |    |
|Chloroquine        |                |        |    |
|Rapamycine         |                |        |    |
...
#### Préparation à faire [^deux] <!-- omit in toc -->:
...
[^deux]: Le laboratoire ne nécéssite pas de solutions ou produits particuliers, tout est fourni par le laboratoire de Claire.
